...
import EquivalenceV2Form from 'components/Equivalence/EquivalenceForm'
import StudentsTable from 'components/Students/StudentsTable'
import EquivalenceV2Table from 'components/Equivalence/EquivalenceTable'
import getStudents from 'services/Students/getStudents'

const Equivalencias: NextPage = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Equivalencias - ITPSM</title>
...
export default withAuth(Equivalencias)
