...
const GetEquivalenceForStudentHistory = async (id:number) => {
  try {
    let url = `${apiInstance.defaults.baseURL}/getequivalence/${id}?`
...
export default GetEquivalenceForStudentHistory
